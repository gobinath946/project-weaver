...
class MailService {
  ...
  async getEmailClient() {
    try {
      ...
      return {
        ...
        from_name: smtpSettings.from_name || 'Project Hub Platform'
      };
  ...
  async sendWelcomeEmail(companyData) {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #3b82f6;">Welcome to Project Hub!</h1>
    ...
    return this.sendEmail({
      to: email,
      subject: 'Welcome to Project Hub - Your Account is Ready!',
      html
    });
  }
  ...
  async sendUserCreatedEmail(userData) {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #3b82f6;">Your Project Hub Account</h1>
        <p>Hello,</p>
    ...
    return this.sendEmail({
      to: email,
      subject: 'Your Project Hub Account Credentials',
      html
    });
  }
}
