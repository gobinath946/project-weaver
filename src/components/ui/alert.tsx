...
const alertVariants = cva(
  "relative w-full rounded-xl border p-4 backdrop-blur-sm [&>svg~*]:pl-8 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4",
  {
    variants: {
      variant: {
        default: "bg-background/50 text-foreground border-border/50 [&>svg]:text-foreground",
        destructive:
