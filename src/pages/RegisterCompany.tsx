      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-3xl font-bold">Project Hub</span>
          </div>
        ...
        <Card className="automotive-shadow">
          <CardHeader>
            ...
            <CardDescription>
              Fill in your company details to create your Project Hub account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-200 mt-5"
                disabled={isLoading}>
                {isLoading ? (
                  <>
